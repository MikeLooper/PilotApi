...
{
	/// <summary>
	/// An interface for a repository that implements CRUD operations for the <see cref="ICategoriesEntity"/> type.
	/// </summary>
	public interface ICategoriesRepository: IRepositoryBase<CategoriesEntity>
	{
	}
}
