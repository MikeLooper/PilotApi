...
namespace PilotApi.Services.Tests.Services
{
	...
	{
		[Test]
		public void ShippersService_Constructor_Throws_When_Null_Args_Test()
		{
			var ex = Assert.Throws<System.Reflection.TargetInvocationException>(() => Activator.CreateInstance(
				typeof(PilotApi.Services.Services.ShippersService),
				null, null, null));
		...
		[Test]
		public void ShippersService_Constructor_Succeeds_Test()
		{
			// arrange
			var loggerFactory = new Mock<ILoggerFactory>();
			var repository = new Mock<IShippersRepository>();
