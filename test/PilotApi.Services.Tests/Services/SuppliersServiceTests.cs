...
namespace PilotApi.Services.Tests.Services
{
	...
	{
		[Test]
		public void SuppliersService_Constructor_Throws_When_Null_Args_Test()
		{
			var ex = Assert.Throws<System.Reflection.TargetInvocationException>(() => Activator.CreateInstance(
				typeof(PilotApi.Services.Services.SuppliersService),
				null, null, null));
		...
		[Test]
		public void SuppliersService_Constructor_Succeeds_Test()
		{
			// arrange
			var loggerFactory = new Mock<ILoggerFactory>();
			var repository = new Mock<ISuppliersRepository>();
