...
namespace PilotApi.Services.Tests.Services
{
	...
	{
		[Test]
		public void OrdersService_Constructor_Throws_When_Null_Args_Test()
		{
			var ex = Assert.Throws<System.Reflection.TargetInvocationException>(() => Activator.CreateInstance(
				typeof(PilotApi.Services.Services.OrdersService),
				null, null, null));
		...
		[Test]
		public void OrdersService_Constructor_Succeeds_Test()
		{
			// arrange
