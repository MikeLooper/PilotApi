...
{
	public class ShippersRepositorySpy : ShippersRepository
	{
		/// <summary>
		/// Instantiates a new instance of the <see cref="ShippersRepositorySpy"/> class.
		/// </summary>
