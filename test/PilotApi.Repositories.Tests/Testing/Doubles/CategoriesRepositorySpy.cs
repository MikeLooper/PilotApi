...
{
	public class CategoriesRepositorySpy : CategoriesRepository
	{
		/// <summary>
		/// Instantiates a new instance of the <see cref="CategoriesRepositorySpy"/> class.
		/// </summary>
		...
		/// </param>
		public CategoriesRepositorySpy(
