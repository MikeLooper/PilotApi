...
{
	public class OrderDetailsRepositorySpy : OrderDetailsRepository
	{
		/// <summary>
		/// Instantiates a new instance of the <see cref="OrderDetailsRepositorySpy"/> class.
		/// </summary>
		...
		/// </param>
		public OrderDetailsRepositorySpy(
