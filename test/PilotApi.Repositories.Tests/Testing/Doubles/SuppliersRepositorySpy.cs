...
{
	public class SuppliersRepositorySpy : SuppliersRepository
	{
		/// <summary>
		/// Instantiates a new instance of the <see cref="SuppliersRepositorySpy"/> class.
		/// </summary>
