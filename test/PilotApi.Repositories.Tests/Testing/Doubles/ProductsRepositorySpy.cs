...
{
	public class ProductsRepositorySpy : ProductsRepository
	{
		/// <summary>
		/// Instantiates a new instance of the <see cref="ProductsRepositorySpy"/> class.
		/// </summary>
