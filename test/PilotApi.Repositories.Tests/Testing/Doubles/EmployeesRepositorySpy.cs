...
{
	public class EmployeesRepositorySpy : EmployeesRepository
	{
		/// <summary>
		/// Instantiates a new instance of the <see cref="EmployeesRepositorySpy"/> class.
		/// </summary>
