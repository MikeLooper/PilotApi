...
{
	public class CustomersRepositorySpy : CustomersRepository
	{
		/// <summary>
		/// Instantiates a new instance of the <see cref="CustomersRepositorySpy"/> class.
		/// </summary>
